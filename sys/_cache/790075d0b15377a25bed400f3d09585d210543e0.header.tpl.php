<?php
/* Smarty version 3.1.30, created on 2017-06-06 15:25:26
  from "C:\wamp\www\bet-admin\app\admin\view\layout\header.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59369f36b1bc06_22123170',
...
function content_59369f36b1bc06_22123170 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<!-- 
...
<head>
    ...
    <!-- BEGIN BASE PATH -->
    <base href="http://localhost/bet-admin/">
    <!-- END BASE PATH -->
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                                                            <li><a href="language/change/1"><img src="assets/global/img/flags/us.png" /> <span class="hide-on-mobile">English</span></a></li>
                                                            <li><a href="language/change/2"><img src="assets/global/img/flags/tr.png" /> <span class="hide-on-mobile">Turkish</span></a></li>
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            ...
                            <span class="username username-hide-on-mobile"> Volkan MUHTAR </span>
                            <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>
